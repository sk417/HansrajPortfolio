            ...
            <h1 className="title">About me</h1>
                <div className="about-content">
                    ...
                    /></span></div>
                        ...
                        <a href="https://drive.google.com/file/d/1yGyeDVax8UXDfKsRZC40An94qxZXNpTv/view?usp=sharing" target='blank'><i className="fa fa-arrow-down" aria-hidden="true"></i>&nbsp;Resume</a>
                    </div>
                </div>
            </div>
