                ...
                <div className="content" data-aos="fade-down">
                    <div className="pg">
                        ...
                        {show && <div className="ans">
                           <p> C </p> <progress value="60" max="100"></progress>
                           <p> C++ </p> <progress value="80" max="100"></progress>
                           <p> Java </p> <progress value="20" max="100"></progress>
                    ...
                    <div className="front">
                        ...
                        {show1 && <div className="ans">
                           ...
                           <p> BootStrap </p> <progress value="10" max="100"></progress>
                           <p> React js </p> <progress value="10" max="100"></progress>
                           <p> JavaScript </p> <progress value="20" max="100"></progress>
                        </div>}
                    </div>
                    <div className="back">
                        ...
                        {show2 &&<div className="ans">
                           <p> Node Js </p> <progress value="10" max="100"></progress>
                           <p> Express js </p> <progress value="10" max="100"></progress>
                        </div>}
                    </div>
                    <div className="db">
                        ...
                        {show3 && <div className="ans">
                           ...
                           <p> MongoDb </p> <progress value="20" max="100"></progress>
                        </div>}
                    </div>
